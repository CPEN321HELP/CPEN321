...
//
//    public int fetchData(Object binding, int facility_type, int page_number, Context applicationContext, boolean is_search, String search_content){
//
//        if(is_search){
//            if(!isCached(facility_type, applicationContext, search_content, is_search)){
//                getDataFromServer(binding, facility_type, page_number, applicationContext, is_search, search_content);
//            }
//            String result = readFromJson(applicationContext, facility_type, search_content, is_search);
//            if(result == null){
//                return local_error;
//            }
//            try {
...
//     *  */
//    private boolean isCached(int facility_type, Context applicationContext, String content_to_search, boolean is_search){
//        String fileName = "";
//        if(is_search){
//            fileName = content_to_search + "_" + getStringType(facility_type)+".json";
//        } else {
//            fileName = "temp_" + getStringType(facility_type)+".json";
//        }        try{
...
//    }
//
//    public void getDataFromServer(Object binding, int facility_type, int page_number, Context applicationContext, boolean is_search, String search_content){
...
//        if(is_search){
//            url += "/search";
//            params.put("search", search_content);
//        }
//        JsonObjectRequest jsObjRequest = new JsonObjectRequest(Request.Method.POST, url, new JSONObject(params), new Response.Listener<JSONObject>() {
//            @Override
//            public void onResponse(JSONObject response) {
//                Log.d(TAG, "response is: " + response.toString());
//                boolean result = writeToJson(applicationContext, facility_type, response, search_content, is_search);
//            }
...
//     *  */
//    private boolean writeToJson(Context applicationContext, int facility_type, JSONObject response, String content_to_search, boolean is_search){
//        String fileName = "";
//        if(is_search){
//            fileName = content_to_search + "_" + getStringType(facility_type)+".json";
//        } else {
...
//     * @return String of corrsponding file; null if error happened
//     *  */
//    private String readFromJson(Context applicationContext, int facility_type, String content_to_search, boolean is_search){
//        String fileName = "";
//        if(is_search){
//            fileName = content_to_search + "_" + getStringType(facility_type)+".json";
//        } else {

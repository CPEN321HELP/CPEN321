...
public final class ActivityReportBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout reportFacilityView;
  ...
  private ActivityReportBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull EditText editTextReport, @NonNull LinearLayout reportFacilityView,
      @NonNull AppCompatButton submitButtonReport) {
    ...
    this.reportFacilityView = reportFacilityView;
  ...
  public static ActivityReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.reportFacilityView;
      LinearLayout reportFacilityView = ViewBindings.findChildViewById(rootView, id);
      if (reportFacilityView == null) {
        break missingId;
      }
      ...
      return new ActivityReportBinding((RelativeLayout) rootView, RateFacilityDescription,
          RateFacilityTitle, cancelButtonReport, checkboxUser, editTextReport, reportFacilityView,
          submitButtonReport);
    }

...
public final class CustomSpinnerItemsBinding implements ViewBinding {
  ...
  private CustomSpinnerItemsBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageView,
  ...
  public static CustomSpinnerItemsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomSpinnerItemsBinding((LinearLayout) rootView, imageView, textView);
    }

...
public final class ActivityFacilityBinding implements ViewBinding {
  ...
  @NonNull
  public final ScrollView facilityActivityView;
  ...
  private ActivityFacilityBinding(@NonNull ScrollView rootView,
      @NonNull ScrollView facilityActivityView, @NonNull TextView facilityAddress,
    ...
    this.facilityActivityView = facilityActivityView;
  ...
  public static ActivityFacilityBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ScrollView facilityActivityView = (ScrollView) rootView;
      ...
      return new ActivityFacilityBinding((ScrollView) rootView, facilityActivityView,
          facilityAddress, facilityDescription, facilityDescriptionTitle, facilityLocationTitle,
          facilityMap, facilityNumberOfRates, facilityRatingText, facilityReport, facilityReviews,
